...
func NewSQLReaderSQLiteWriter(readConn *sql.DB, writeConn *sql.DB, readQuery, writeTable string) *SQLReaderSQLiteWriter {
...
func NewDynamicSQLReaderSQLiteWriter(readConn *sql.DB, writeConn *sql.DB, sqlGenerator func(data.JSON) (string, error), writeTable string) *SQLReaderSQLiteWriter {
