...
func NewSQLReaderMySQLWriter(readConn *sqlx.DB, writeConn *sqlx.DB, readQuery, writeTable string) *SQLReaderMySQLWriter {
...
func NewDynamicSQLReaderMySQLWriter(readConn *sqlx.DB, writeConn *sqlx.DB, sqlGenerator func(data.JSON) (string, error), writeTable string) *SQLReaderMySQLWriter {
