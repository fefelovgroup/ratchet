...
<img align="right" src="http://assets1.fefelovgroup.com/random/the-ratchet.png" style="margin-left:20px">
...
![Pipeline Drawing](http://assets1.fefelovgroup.com/random/ratchet-pipeline-concept.png)
...
- Check out the full Godoc reference:
 [![GoDoc](https://godoc.org/github.com/fefelovgroup/ratchet?status.svg)](https://godoc.org/github.com/fefelovgroup/ratchet)
- Get Ratchet:
      go get github.com/fefelovgroup/ratchet
  ...
  you can download them into your project's vendor folder--along with ratchet--by running:
        ...
        govendor sync
        govendor add github.com/fefelovgroup/ratchet
        govendor add github.com/fefelovgroup/ratchet/data
        govendor add github.com/fefelovgroup/ratchet/logger
        govendor add github.com/fefelovgroup/ratchet/processors
        govendor add github.com/fefelovgroup/ratchet/util
...
Ratchet could be used anytime you need to perform some type of custom ETL. At fefelovgroup we use Ratchet mainly to handle extracting data from our application databases, transforming it into reporting-oriented formats, and then loading it into our dedicated reporting databases.
